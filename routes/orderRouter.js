const {initPayment,createOrder,createCodOrder,getSingleOrder,getLoggedInOrders,getAllOrders,updateOrder,deleteOrder,paymentConform}=require("../controllers/ordersController")
const {isAuthorized,roleAuthorize}=require("../middleware/auth")
const Router=require("express").Router()

Router.route("/initpayment").post(initPayment)
Router.route("/order/new").post(isAuthorized,paymentConform,createOrder)
Router.route("/order/cod/new").post(isAuthorized,createCodOrder)
